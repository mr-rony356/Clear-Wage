...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, TextField, Select, MenuItem, FormControl, InputLabel, IconButton, OutlinedInput, InputAdornment, Box, Typography, useMediaQuery, useTheme } from '@mui/material';
...
function Modal({ open, onClose }) {
    ...
    return (
        <div>
            {!showPopup &&
                (
                    <Dialog open={open} onClose={onClose} sx={{
                        ...
                        <DialogTitle>Step {step}: Multi-Step Form</DialogTitle>
                        ...
                        <DialogContent dividers>
                                ...
                                <>
                                    <FormControl fullWidth>
                                        ...
                                        >
                                            ...
                                            <MenuItem value="Non-equity partner">Non-equity partner</MenuItem>
                                            <MenuItem value="Equity partner">Equity partner</MenuItem>
                                            <MenuItem value="Of counsel">Of counsel</MenuItem>
                                            <MenuItem value="In-House General Counsel">In-House General Counsel</MenuItem>
                                        </Select>
                                    </FormControl>
                                ...
                                <>
                                    <FormControl fullWidth>
                                        ...
                                        >
                                            ...
                                            <MenuItem value="Insurance">Insurance</MenuItem>
                                            <MenuItem value="Intellection Property">Intellection Property</MenuItem>
                                            <MenuItem value="Labor & Employment">Labor & Employment</MenuItem>
                                            <MenuItem value="Real Estate">Real Estate</MenuItem>
                                            <MenuItem value="Tax">Tax</MenuItem>
                                            <MenuItem value="Transportation">Transportation</MenuItem>
                                            <MenuItem value="Trusts & Estates">Trusts & Estates</MenuItem>
                            ...
                            {step === 8 && (
                                <> <FormControl fullWidth>
                                    <InputLabel htmlFor="outlined-adornment-amount">Bonuses</InputLabel>
                                    <OutlinedInput
                                        id="outlined-adornment-amount"
                                        name='Bonuses'
                                        startAdornment={<InputAdornment position="start">$</InputAdornment>}
                            ...
                            {step === 9 && (
                                <>
                                    <TextField
                                        label="Minimum Annual Billable Requirement"
                                        name="MinAnnualBillableRequirement"
                                        value={formData.MinAnnualBillableRequirement}
                                        onChange={handleInputChange}
                                        fullWidth
                                    />
                                    {/* Add other input fields for step 9 if needed */}
                                </>
                            )}
                            {step === 10 && (
                                <>
            ...
            {showPopup && (
                <Dialog fullScreen={isMobile ? true : false} style={{ maxWidth: 'sm', height: 'auto' }} open={open} onClose={onClose} sx={{

                }}>
                    <DialogTitle style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                        <Box>
                            <Typography variant='h5 ' sx={{
                                fontSize: '20px'
                            }}> Wait! Before reviewing the data!</Typography>
                            <Typography sx={{
                                margin: '10px 0 0 0',
                                fontSize: '12px'
                            }}>We are sponsored by Holtz & Bernard, an attorney recruitment firm in Miami, FL. Are you open to hearing about new attorney opportunities? If so, enter your info and they will reach out!</Typography>
                        </Box>
                    ...
                    <DialogActions className='flex-center'>
                        <Button onClick={handlePopupSubmit} sx={{
                            background: 'white',
                            color: '#3182ce',
                            width: '40%',
